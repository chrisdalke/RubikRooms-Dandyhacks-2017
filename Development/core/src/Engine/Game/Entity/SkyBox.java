...
public class SkyBox implements Disposable {
    ...
    public SkyBox (Texture positiveX, Texture negativeX, Texture positiveY, Texture negativeY, Texture positiveZ, Texture negativeZ) {

        textures = new Texture[6];

        textures[3] = (positiveX);
        textures[2] = (negativeX);

        textures[4] = (positiveY);
        textures[5] = (negativeY);

        textures[0] = (positiveZ);
        textures[1] = (negativeZ);
