 ...
 * @author Xoppa */
public class CustomDirectionalShadowLight extends DirectionalLight implements ShadowMap, Disposable {
    ...
    /** @deprecated Experimental, likely to change, do not use! */
    public CustomDirectionalShadowLight (int shadowMapWidth, int shadowMapHeight, float shadowViewportWidth, float shadowViewportHeight,
